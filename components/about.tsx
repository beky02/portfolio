          ...
          <div className="flex flex-col text-secondary-100 leading-relaxed lg:w-1/2">
            ...
            <div className="flex flex-col gap-y-8 font-normal">
              <p
                ...
                data-aos-delay="600"
              >
                Hi, I'm a Flutter and Full Stack Developer who's passionate
                about building innovative mobile and web applications.
                Proficient in Flutter, React.js, Next.js, FastAPI, and Nest.js.
              ...
              <p
                ...
                data-aos-delay="1000"
              >
                I'm all about collaboration and continuous learning. The tech
                world is always evolving, and I'm here for it—always eager to
                pick up new skills and stay ahead of the curve.{" "}
              </p>
              <p
                data-aos="fade-right"
                data-aos-delay="1200"
