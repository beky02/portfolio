        ...
        <div className="h-full flex flex-col justify-center items-center my-10 gap-y-20 text-center">
          <div className="flex flex-col text-secondary-100 text-6xl font-bold gap-y-10">
            ...
            <p className="text-[#8892b0]">
              I am a Front End Developer based in Ethiopia. I am currently
              available for freelance work. If you have a project that you want
              to get started, think you need my help with something or just fancy
          ...
          {/* <Button
            className="w-80 py-5 text-primary"
            onClick={() => {
